		...
		<div class="row">
			<div class="card col m4 offset-m4 s10 offset-s1 z-depth-4 white darken-2">
				<div class="card-content">
					<p class="center"><a href="/backup/create" class="waves-effect waves-light btn-large grey darken-10"><i class="material-icons left">backup</i>Create Backup</a></p>
				</div>
			</div>
		</div>
		<div class="row">
					...
					@if(count($backups) > 0)
						@foreach($backups as $b)
							<tr>
								...
								<td>
									<a href="/backup/download?file_name={{ urlencode($b['file_name']) }}" class="btn grey darken-10 waves-effect waves-light"><i class="material-icons">file_download</i></a>
