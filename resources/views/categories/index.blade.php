    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">class</i> Categories
          <button data-target="modal1" class="btn waves-effect grey darken-10 modal-trigger right">Add New</button>
        </h3>
        <div class="divider"></div>
      </div>
      <div class="card z-depth-2">
        <div class="card-content">
        <button class="btn red waves-effect grey darken-10 delete_all" data-url="{{ url('categoriesDeleteMulti') }}">Delete All Selected</button>
...
<div id="modal1" class="modal">
  ...
  <div class="modal-footer grey darken-10">
