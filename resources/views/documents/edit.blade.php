    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">mode_edit</i> Edit Document
          <a href="/documents" class="btn waves-effect grey darken-10 right tooltipped" data-position="left" data-delay="50" data-tooltip="Go Back"><i class="material-icons">arrow_back</i> Back</a>
        </h3>
        ...
        <div class="col m8 s12">
          ...
          <div class="card">
            <div class="card-content">
              ...
              <div class="input-field">
                <p class="center">
                  {{ Form::submit('Save Changes',['class' => 'btn-large waves-effect grey darken-10']) }}
                </p>
              </div>
            </div>
          </div>
