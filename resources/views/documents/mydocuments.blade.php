  ...
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        ...
        @can('upload')
          <a href="/documents/create" class="btn waves-effect grey darken-10t right tooltipped" data-position="left" data-delay="50" data-tooltip="Upload New Document"><i class="material-icons">file_upload</i> New</a>
        @endcan
        </h3>
