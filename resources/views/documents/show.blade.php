    ...
    <div class="col m11 s12">
      <div class="row">
        ...
        <div class="btn-icons">
          ...
          @can('shared')
          <a href="#" class="btn-circle purple waves-effect grey darken-10 data-share tooltipped" data-position="top" data-delay="50" data-tooltip="Share this" data-form="documents-{{ $doc->id }}"><i class="material-icons">share</i></a>
          @endcan
          {!! Form::close() !!}
          <!-- DELETE using link -->
