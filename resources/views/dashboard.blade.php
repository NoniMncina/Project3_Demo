          ...
          <div class="col m4 s6">
            <div class="card hoverable grey darker-10  white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Documents<span class="new badge white-text">20</span></h4>
              </div>
            </div>
          </div>
        </a>
          ...
          <div class="col m4 s6">
            <div class="card hoverable grey darker-10 white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Users<span class="new badge white-text">10</span></h4>
              </div>
            </div>
          </div>
        </a>
